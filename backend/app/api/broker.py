...
from app.services.broker_service import verify_angel, verify_dhan
...
def add_broker(data: BrokerCreate, db: Session = Depends(get_db)):
    ...
    broker = BrokerAccount(
        ...
        is_connected=False,
        is_active=True,
        is_selected=False  # ✅ ensure default
    )
    ...
    return [
        {
            ...
            "broker_user_id": b.broker_user_id,
            "is_active": b.is_active,
            "is_connected": b.is_connected,
            "is_selected": b.is_selected  # ✅ IMPORTANT (added)
        }
        for b in brokers
    ]